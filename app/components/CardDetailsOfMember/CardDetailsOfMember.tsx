                ...
                <div className='flex flex-col gap-4 w-full'>
                    ...
                    <div className="flex-1 bg-white rounded-2xl shadow-lg p-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {[...Array(4)].map((_, i) => <CardProgressSkeleton key={i} />)}
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className='flex flex-col md:flex-row gap-7 w-full p-6'>
            <div className='flex flex-col gap-3'>
                <CardProfile
                imageUrl={data.profile_image ? `https://eb90-102-189-197-60.ngrok-free.app/${data.profile_image.replace(/\\/g, '/')}` : ''}
                email={data.email}
                ...
                <div className="flex-1 bg-white rounded-2xl shadow-lg p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <CardProgress
                            ...
                            total={(data.lesson?.length || 0) + (data.completedlesson?.length || 0)}
                            color="purple"
                        />
                        <CardProgress
                            title="Roadmaps"
